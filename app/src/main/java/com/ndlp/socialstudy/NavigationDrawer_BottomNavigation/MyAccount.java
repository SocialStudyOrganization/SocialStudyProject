...
public class MyAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //find title workaround
        TextView tv_toolbar_title_workaround_account = (TextView) findViewById(R.id.tv_toolbar_title_workaround_account);

        //adjust typefaces
        tv_toolbar_title_workaround_account.setTypeface(quicksand_bold);
        ...
        logoutbutton.setTypeface(quicksand_bold);
        changepassword.setTypeface(quicksand_bold);
        sendAccoundData.setTypeface(quicksand_bold);
