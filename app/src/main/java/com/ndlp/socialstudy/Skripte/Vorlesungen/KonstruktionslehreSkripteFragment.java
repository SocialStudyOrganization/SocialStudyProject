...
public class KonstruktionslehreSkripteFragment extends Fragment {
    public static KonstruktionslehreSkripteFragment newInstance() {
        KonstruktionslehreSkripteFragment konstruktionslehreSkripteFragment = new KonstruktionslehreSkripteFragment();
        return konstruktionslehreSkripteFragment;
    }
...
//---------------------------------ONCREATE----------------------------------------------------------
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_konstruktionslehre_skripte, container, false);


        //  initialize the recyclerView of the data files
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.rv_skripteKonstruktionslehre);
