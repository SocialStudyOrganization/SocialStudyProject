...
public class InformatikSkripteFragment extends Fragment {
    public static InformatikSkripteFragment newInstance() {
        InformatikSkripteFragment informatikSkripteFragment = new InformatikSkripteFragment();
        return informatikSkripteFragment;
    }
...
//---------------------------------ONCREATE----------------------------------------------------------
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_informatik_skripte, container, false);


        //  initialize the recyclerView of the data files
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.rv_skripteInformatik);
