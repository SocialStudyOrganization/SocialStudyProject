...
public class KonstruktionslehreTasksFragment extends Fragment {
    public static KonstruktionslehreTasksFragment newInstance() {
        KonstruktionslehreTasksFragment konstruktionslehreTasksFragment = new KonstruktionslehreTasksFragment();
        return konstruktionslehreTasksFragment;
    }
