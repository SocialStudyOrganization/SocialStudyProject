...
public class AussenwirtschaftTasksFragment extends Fragment {
    public static AussenwirtschaftTasksFragment newInstance() {
        AussenwirtschaftTasksFragment aussenwirtschaftTasksFragment = new AussenwirtschaftTasksFragment();
        return aussenwirtschaftTasksFragment;
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == READ_REQUEST_CODE && resultCode == Activity.RESULT_OK){
            ...
            if (data != null){
                ...
                FileUploader fileUploader = new FileUploader(getActivity(), fileUri, taskname, format, category, date, time, user, subFolder, urlAddress, mRecyclerView);
