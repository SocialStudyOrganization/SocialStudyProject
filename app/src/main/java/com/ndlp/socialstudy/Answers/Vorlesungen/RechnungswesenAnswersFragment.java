...
public class RechnungswesenAnswersFragment extends Fragment {
    public static RechnungswesenAnswersFragment newInstance() {
        RechnungswesenAnswersFragment rechnungswesenAnswersFragment = new RechnungswesenAnswersFragment();
        return rechnungswesenAnswersFragment;
    }
